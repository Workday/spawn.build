...
/**
 * The {@code Docker Engine} {@link Command} to pause a {@code Container} using the
 * <a href="https://docs.docker.com/engine/api/v1.41/#operation/ContainerPause">Pause Container</a> command.
 *
 * @author brian.oliver
 * @since Jul-2021
 */
public class PauseContainer
    ...
    protected HttpTransport.Request createRequest() {
        ...
        return HttpTransport.Request.post(
            "/containers/" + this.container.id() + "/pause", null);
    }
