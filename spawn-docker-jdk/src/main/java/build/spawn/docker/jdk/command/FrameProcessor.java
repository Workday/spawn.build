...
/**
 * Asynchronously processes the {@code stdin}, {@code stdout} and {@code stderr} frames produced
...
class FrameProcessor
     ...
     */
    FrameProcessor(final InputStream inputStream,
    ...
    @Override
    public void run() {
        try (var inputStream = this.inputStream) {
