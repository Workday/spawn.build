...
public class InspectContainer
    ...
    protected HttpTransport.Request createRequest() {
        return HttpTransport.Request.get("/containers/" + this.container.id() + "/json");
    }
    ...
    @Override
    protected Optional<Container.Information> createResult(final HttpTransport.Response response)
        throws IOException {
        ...
        return Optional.of(context.create(build.spawn.docker.jdk.model.ContainerInformation.class));
    }
}
