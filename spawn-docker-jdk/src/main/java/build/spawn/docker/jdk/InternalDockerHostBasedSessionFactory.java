...
/**
 * The {@link Session.Factory} for <code>host.docker.internal</code> based {@link TCPSocketBasedSession}s.
 *
 * @author brian.oliver
 * @since Aug-2022
 */
public class InternalDockerHostBasedSessionFactory
    implements Session.Factory {

    /**
     * The {@link InetSocketAddress} for the <code>host.docker.internal</code>-based Docker Daemon.
     */
    private final static InetSocketAddress ADDRESS = new InetSocketAddress("host.docker.internal", 2375);
