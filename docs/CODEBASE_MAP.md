...
| `LocalLauncherRegistration.java` | `LauncherRegistration` record: maps `LocalMachine + Application → LocalLauncher`; declared in `module-info.java` with `provides` |
...
| `LocalJDKLauncherRegistration.java` | `LauncherRegistration` record: maps `LocalMachine + JDKApplication → LocalJDKLauncher`; declared in `module-info.java` with `provides` |
