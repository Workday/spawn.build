...
import build.spawn.docker.okhttp.command.CreateContainer;
import build.spawn.docker.okhttp.command.DeleteImage;
import build.spawn.docker.okhttp.command.InspectImage;
import build.spawn.docker.okhttp.command.StartContainer;
...
public class OkHttpBasedImage
    ...
    /**
     * Constructs an {@link OkHttpBasedImage} with the specified identity.
     *
     * @param id the {@link Image} identity
     */
    public OkHttpBasedImage(final String id) {
     ...
     * {@link build.spawn.docker.okhttp.command.Command}s.
     *
